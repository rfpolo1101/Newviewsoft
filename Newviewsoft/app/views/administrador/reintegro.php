...
<!--***************************************FROM**************************************-->
  <form action="<?php echo RUTA_URL ?>/aprendices/novedades/reintegro"  method="post" enctype="multipart/form-data" >
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" >
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                  ...
                  Fecha Inicial Reintegro
                    <label  for="fecha_inicial" class="sr-only" >Fecha Inicial Reintegro</label>
                      <div class="">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                  ...
                  Fecha Final Reintegro
                    <label  for="fecha_final" class="sr-only" style="color #FFFFFF;" >Fecha Final Reintegro</label>
                      <div class="">

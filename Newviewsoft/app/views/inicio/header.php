...
<?php endif;?>
  ...
  <ul class="nav navbar-nav navbar-right">
         <li class="dropdown">
                ...
                <ul class="dropdown-menu" >
<?php if (isset($_SESSION["Super_admin"])): ?> <li><a href="<?php echo RUTA_URL; ?>/usuario/asignar"><span class="glyphicon glyphicon-book"></span> Asignar Rol</a></li><?php endif;?>
 ...
 <form class="navbar-form navbar-right" role="search" action="<?php echo RUTA_URL ?>/buscar/usuarios" method="POST">
        <div class="dropdown btn-group">
          ...
          <ul class="dropdown-menu">
          <?php if (isset($_SESSION["Administrador"])): ?>  <li><a tabindex="-1" href="<?php echo RUTA_URL ?>/buscar/usuarios">Usuarios</a></li> <?php endif?>

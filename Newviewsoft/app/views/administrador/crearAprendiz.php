                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <div class="form-group">
                    <label  for="snom" class="sr-only" ></label>
                      <div class="">
                      <input type="text" id="snom" name="segundo_nombre" autocomplete="OFF"  placeholder=" Segundo Nombre"  class="form-control">
                      </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                   <label for="ficha"  class="sr-only">Ficha</label>
                      ...
                      if ($datos->codigo_ficha != "0" and $datos->fk_estado != 2):

...
<!--***************************************FROM**************************************-->
  <form action="<?php echo RUTA_URL ?>/aprendices/novedades/cambio-jornada"  method="post" enctype="multipart/form-data" >
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" >
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                  ...
                  Fecha Inicial Cambio de Jornada
                    <label  for="fecha_inicial" class="sr-only" >Fecha Inicial Cambio de Jornada</label>
                      <div class="">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                  ...
                  Fecha Final Cambio de Jornada
                    <label  for="fecha_final" class="sr-only" style="color #FFFFFF;" >Fecha Final Cambio de Jornada</label>
                      <div class="">

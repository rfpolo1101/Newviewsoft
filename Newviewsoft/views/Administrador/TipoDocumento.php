...
<div class="collapse navbar-collapse" id="myNavbar">
  ...
  <form action="<?php  echo htmlspecialchars ($_SERVER["PHP_SELF"]); echo '?tipos=TipoDocumento'?>"  method="post"> 
    <div class="col-md-12">
      <div class="col-md-3">
      </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="documento" class="sr-only" >Documento</label> 
                      <div class="">
                      <input type="text" id="tdocumento" name="tdocumento" autocomplete="OFF" required="" placeholder="Documento"  class="form-control">
                      </div>
                  </div>
                </div> 
              </div>

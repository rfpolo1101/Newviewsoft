...
<!--***************************************FROM**************************************-->
  <form action="<?php echo RUTA_URL ?>/aprendices/novedad/desercion"  method="post" enctype="multipart/form-data" >
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-xs-4 nov">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" >
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                Fallas
                  <label  for="fallas" class="sr-only" >Fallas </label>
                    <div class="">
                    <input type="number" id="fallas" name="fallas" autocomplete="OFF" required="" placeholder="fallas"  class="form-control" required="">
                    </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-7 col-xs-7 clase" style="margin-top: 30px">
          ...
          <div class="formulario form-group">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label  for="documento" class="sr-only" >Documento Aprendiz</label>
                      <div class="">
                      <input type="text" id="documento" name="documento" autocomplete="OFF" required="" placeholder="Documento Aprendiz"  class="form-control" required="">
                      </div>
                  </div>
                </div>
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label  for="motivo" class="sr-only" >Motivo</label>
                      <div class="">
                      <textarea type="text" id="motivo" name="motivo" autocomplete="OFF" required="" placeholder="Motivo"  class="form-control" cols="10" rows="5" required=""></textarea>
                      </div>
                  </div>
              </div>
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label  for="respuesta" class="sr-only" >Respuesta</label>
                      <div class="">
                      <textarea type="text" id="respuesta" name="respuesta" autocomplete="OFF" required="" placeholder="Respuesta"  class="form-control" cols="10" rows="5" required=""></textarea>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    <label  for="documento_instructor" class="sr-only" >Documento del Instructor</label>
                      <div class="">
                      <input type="text" id="documento_instructor" name="documento_instructor" autocomplete="OFF" required="" placeholder="Documento del Instructor"  class="form-control" required="">
                      </div>
                </div>
              </div>
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="file" id="acta" name="acta" autocomplete="OFF"  placeholder="Acta"  class="form-control">
                        </div>
                    </div>
              </div>

    ...
    <div class="container col-md-12">
        ...
        <div class="carousel-inner">
             <div class="item active">
                <img src="/Newviewsoft/views/Diseños/img/imag6.jpg" alt="TÉCNOLOGIA" title="TÉCNOLOGIA" style="width: ; height:;" >
             </div>

             <div class="item">
                <img src="/Newviewsoft/views/Diseños/img/imag4.png" alt="SEDE COLOMBIA" title="SEDE COLOMBIA" style="width: 100%; height: 50%;"  >
             </div>

              <div class="item">
                <img  src="/Newviewsoft/views/Diseños/img/imag2.jpg" alt="BIENVENIDOS" title="BIENVENIDOS" style="width: 100%; height: 50%;" >
             </div>
             <div class="item">
                <img  src="/Newviewsoft/views/Diseños/img/imag8.jpg" alt="SENA" title="SENA" style="width: 100%; height: 50%;" >
             </div>
             <div class="item">
                <img  src="/Newviewsoft/views/Diseños/img/imag9.jpg" alt="FUTURO" title="FUTURO" style="width:; height: ;" >
             </div>
        </div>
  ...
  <!-- CONTROLES DE IZQUIERDA A DERECHA -->
        ...
        <div class="col-md-3">
          <ul class="nav nav-pills nav-stacked navbar-inverse" style="margin: 10px;">
            ...
            <li><a href="crear?tipos=Formacion"> Formación</a></li>
            <li><a href="crear?tipos=Trimestre"> Trimestre</a></li>
            <li><a href="crear?tipos=Jornada"> Jornada</a></li>
            <li><a href="crear?tipos=Ficha"> Ficha</a></li>
            <li><a href="crear?tipos=Sede"> Sede</a></li> 
            <li><a href="crear?tipos=TipoDocumento">Documento</a></li>
                  <li class="divider"></li>  
                </ul>
            </li>
          </ul>

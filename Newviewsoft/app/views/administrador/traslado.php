...
<!--***************************************FROM**************************************-->
  <form action="<?php echo RUTA_URL ?>/aprendices/novedades/traslado"  method="post" enctype="multipart/form-data" >
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" >
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                  ...
                  Fecha Inicial Traslado
                    <label  for="fecha_inicial" class="sr-only" >Fecha Inicial Traslado</label>
                      <div class="">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                  ...
                  Fecha Final Traslado
                    <label  for="fecha_final" class="sr-only" style="color #FFFFFF;" >Fecha Final Traslado</label>
                      <div class="">
